        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="flex align-items-center">
                    <Button :disabled="layoutConfig.scale.value === scales[0]"
                    ...
                    <Button :disabled="layoutConfig.scale.value === scales[scales.length - 1]"
                ...
                <template v-if="!simple">
                    ...
                    <div class="flex">
                        <div class="field-radiobutton flex-1">
                            <RadioButton v-model="layoutConfig.inputStyle.value" inputId="outlined_input"
                                         name="inputStyle"
                                         value="outlined"></RadioButton>
                            <label for="outlined_input">Outlined</label>
                        </div>
                        <div class="field-radiobutton flex-1">
                            <RadioButton v-model="layoutConfig.inputStyle.value" inputId="filled_input"
                                         name="inputStyle"
                                         value="filled"></RadioButton>
                ...
                <div class="grid">
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('bootstrap4-light-blue', 'light')">
                            <img alt="Bootstrap Light Blue" class="w-2rem h-2rem"
                    ...
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('bootstrap4-light-purple', 'light')">
                            <img alt="Bootstrap Light Purple" class="w-2rem h-2rem"
                    ...
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('bootstrap4-dark-blue', 'dark')">
                            <img alt="Bootstrap Dark Blue" class="w-2rem h-2rem"
                    ...
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('bootstrap4-dark-purple', 'dark')">
                            <img alt="Bootstrap Dark Purple" class="w-2rem h-2rem"
                ...
                <div class="grid">
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('md-light-indigo', 'light')">
                            <img alt="Material Light Indigo" class="w-2rem h-2rem"
                    ...
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('md-light-deeppurple', 'light')">
                            <img alt="Material Light DeepPurple" class="w-2rem h-2rem"
                ...
                <div class="grid">
                    ...
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('mdc-light-deeppurple', 'light')">
                            <img alt="Material Light Deep Purple" class="w-2rem h-2rem"
                                 src="/layout/images/themes/md-light-deeppurple.svg"/>
                        </button>
                    </div>
                    <div class="col-3">
                    ...
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('mdc-dark-deeppurple', 'dark')">
                            <img alt="Material Dark Deep Purple" class="w-2rem h-2rem"
                                 src="/layout/images/themes/md-dark-deeppurple.svg"/>
                        </button>
                    </div>
                </div>
                ...
                <div class="grid">
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('tailwind-light', 'light')">
                            <img alt="Tailwind Light" class="w-2rem h-2rem"
                ...
                <div class="grid">
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('lara-light-indigo', 'light')">
                            <img alt="Lara Light Indigo" class="w-2rem h-2rem"
                    ...
                    <div class="col-3">
                        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('lara-dark-indigo', 'dark')">
                            <img alt="Lara Dark Indigo" class="w-2rem h-2rem"
